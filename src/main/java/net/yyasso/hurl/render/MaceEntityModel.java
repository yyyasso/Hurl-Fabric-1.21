...
public class MaceEntityModel extends Model {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData top_r1 = bb_main.addChild("top_r1", ModelPartBuilder.create().uv(24, 4).cuboid(-2.0F, -2.0F, -2.0F, 2.0F, 2.0F, 2.0F, new Dilation(0.0F)), ModelTransform.of(1.0F, 1.0F, 0.0F, -0.7854F, 0.0F, 0.0F));
